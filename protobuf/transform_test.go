...
import (
	...
	"github.com/TroyWind/proteus/report"
...
func (s *TransformerSuite) TestTransform() {
	...
	s.Equal("github.com/TroyWind/proteus/fixtures", pkg.Path)
	...
	s.Equal([]string{
		...
		"google/protobuf/timestamp.proto",
		"github.com/TroyWind/proteus/fixtures/subpkg/generated.proto",
	}, pkg.Imports)
	...
	s.Equal("github.com/TroyWind/proteus/fixtures/subpkg", pkg.Path)
...
const project = "github.com/TroyWind/proteus"
